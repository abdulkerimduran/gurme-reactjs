        ...
        return (
            <div className="section section-padding related-products pt-0">
                <div className="container">
                    <h3>Bunları da deneyebilirsiniz</h3>
                    <div className="row menu-v2">
                        {/* Product Start */}
                        {this.props.products.slice(0, 3).map((item, i) => (
                                ...
                                <div className="product">
                                    ...
                                    <div className="product-body">
                                        <div className="product-desc">
                                            ...
                                            <p>{item.shortdesc}</p>
                                            <button type="button" className="btn-custom light btn-sm shadow-none" onClick={(e) => this.modalShow(item.id)}> Seçenekler <i className="fas fa-plus" /> </button>
                                        </div>
                                        <div className="product-controls">
                                            <p className="product-price">{new Intl.NumberFormat().format((item.price).toFixed(2))}₺</p>
                                            <Link to={"/menu-item-v1/" + item.id} className="order-item btn-custom btn-sm shadow-none">SİPARİŞE EKLE <i className="fas fa-shopping-cart" /> </Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
